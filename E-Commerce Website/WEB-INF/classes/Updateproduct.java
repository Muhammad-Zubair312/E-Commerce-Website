    ...
    public void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        ...
        try (ShopDAO obj = new ShopDAO()){
            ...
            if (check == 1){
                ...
                out.println("<form method='post' action='UpdateHandler'>");
                out.println("<input type='hidden' name='name' value='" + name + "'>");
                out.println("Select what to update:<br>");
                out.println("<input type='radio' name='updateOption' value='category'>Update Category<br>");
                out.println("<input type='radio' name='updateOption' value='description'>Update Description<br>");
                out.println("<br>");
